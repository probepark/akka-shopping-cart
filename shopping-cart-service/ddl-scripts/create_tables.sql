...
CREATE
UNIQUE INDEX event_journal_ordering_idx ON public.event_journal (ordering);
...
CREATE
INDEX IF NOT EXISTS projection_name_index ON akka_projection_offset_store (projection_name);
